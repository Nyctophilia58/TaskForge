...
class TaskDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final taskAsync = ref.watch(projectTasksProvider(projectId));
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _buildDetailItem('Hourly Rate',
                              '\$${task.hourlyRate.toStringAsFixed(2)}',
                              Icons.attach_money, theme),
                          const Divider(height: 30),
                          if (task.developerId != null)
                            _buildDetailItem(
                                'Assigned Developer', 'ID: ${task.developerId}',
                                Icons.person, theme),
                          if (task.hoursSpent != null) ...[
                            const Divider(height: 30),
                            _buildDetailItem('Hours Spent',
                                task.hoursSpent!.toStringAsFixed(1),
                                Icons.timer, theme),
                            const Divider(height: 30),
                            _buildDetailItem(
                              task.status == 'paid'
